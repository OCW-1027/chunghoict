...
fbReady = false; // ChunghoICT: Firebase disabled
...
function exportGLExcel(){
  ...
  html+='<h2 style="font-size:14pt;color:#1e3a5f">ChunghoICT Japan Co., Ltd.　総勘定元帳</h2>';
...
<h1>損 益 計 算 書</h1>
<div class="sub">ChunghoICT Japan Co., Ltd.<br>自 令和7年6月2日（設立日）至 令和8年4月2日（暫定）<br>（単位：円）</div>
...
<div class="stamp"><div class="s1">決裁</div><div class="s2">本人専決</div></div>
<h1>貸 借 対 照 表</h1>
<div class="sub">ChunghoICT Japan Co., Ltd.<br>令和8年4月2日現在（暫定）<br>（単位：円）</div>
...
<div class="footer">ChunghoICT 財務管理システム ｜ 出力日: ${dateStr} ｜ 本書は暫定値に基づく参考資料です</div>
</body></html>`;
